        ...
        <div class="main-panel">
		  ...
		  <form method="post"  >
            <div class="row" id="filterdata"  >
			  	<?php
$ret=mysqli_query($con,"select * from user_designs");
$countcol=0;
 ...
 <?php
	...
	?>
                      ...
                      <div class="col-2">
                        <div class="d-flex align-items-center align-self-start">
                              <i class="mdi mdi-heart"></i>
                            <?php	$retc=mysqli_query($con,"select * from likes WHERE design_id='$thisid' AND design_type='user' ");
			$likecount=0;
