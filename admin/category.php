...
$sql=mysqli_query($con,"insert into category(categoryName,categoryDescription,designtypeid,category_show_name) values('$category','$description','$designtype','$category')");
...
<?php $query=mysqli_query($con,"select category.id, category.category_show_name, category.categoryDescription, category.creationDate, category.updationDate, stairdesigns.design_name  from category, designtype, stairdesigns
 WHERE category.designtypeid=designtype.id 
